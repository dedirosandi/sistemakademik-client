...
require_once dirname(__FILE__) . '../../../../../env/midtrans/Midtrans.php';
...
if ($transaction == 'settlement') {
    ...
    mysqli_query($koneksi, "update tb_transaksi_pembayaran set transaction_status='2', transaction_id='$transaction_id' where order_id='$order_id'");
