...
<section class="section">
    <div class="card shadow">
        ...
        <div class="card-body">
            <form action="?pages=mata-pelajaran&act=proses-tambah-mata-pelajaran" method="post">
                <div class="col-lg-12">
                    <div class="mb-3 row">
                        <label class="col-sm-3 col-form-label col-form-label-sm">Nama Mata Pelajaran</label>
                        <div class="col-sm-9">
                            <input type="text" name="nama_mata_pelajaran" class="form-control form-control-sm" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <div class="col-sm-9">
