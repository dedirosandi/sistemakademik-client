<div class="page-heading">
    <a class="btn btn-success" href="?pages=kelas">Kembali </a>
</div>
<?php
...
<section class="section">
    <div class="card shadow">
        <div class="card-header">
            <a class="btn btn-success" href="?pages=kelas&act=tambah-kelas&id_tahun_akademik=<?= $tahun_akademik["id"]; ?>">Tambah Kelas</a>
        </div>
        <div class="card-body">
            <table class="table table-striped" id="table1">
                ...
                <tbody>
                    <?php
                    $no = 1;
                    $GetKelas = query("SELECT * FROM tb_kelas WHERE tahun_akademik='$id_tahun_akademik'");
