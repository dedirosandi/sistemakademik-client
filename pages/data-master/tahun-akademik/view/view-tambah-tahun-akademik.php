 ...
 <section class="section">
     <div class="card shadow">
         ...
         <div class="card-body">
             <form action="?pages=tahun-akademik&act=proses-tambah-tahun-akademik" method="post">
                 <div class="col-lg-12">
                     <div class="mb-3 row">
                         ...
                         <div class="col-sm-9">
                             <?php
                                $year = date('Y');
                                ?>
                             <input type="text" name="tahun" class="form-control form-control-sm" value="<?= $year ?>" readonly required>
                         </div>
                     </div>
                     <div class="mb-3 row">
                         <label class="col-sm-3 col-form-label col-form-label-sm">Nama Tahun</label>
                         <div class="col-sm-9">
                             <input type="text" name="nama_tahun" class="form-control form-control-sm" required>
                         </div>
                     </div>
                     <div class="mb-3 row">
                         <div class="col-sm-9">
