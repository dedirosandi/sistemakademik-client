...
if (mysqli_fetch_assoc($Cek)) {
    echo "  <script>
    		    document.location.href='/?pages=kepala-sekolah&pesan=coba-lagi';
    	    	</script>";
    return false;
}
...
$insert = mysqli_query($koneksi, "INSERT INTO tb_user VALUES ('$userid','$nama','$username','$password','kepsek','1')");
...
if ($insert) {
    ...
    echo "  <script>
            document.location.href='/?pages=kepala-sekolah&act=tambah-kepala-sekolah';
            </script>";
}
